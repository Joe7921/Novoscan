...
作为成员、贡献者和维护者，我们承诺为每个人提供一个**无骚扰**的社区体验，不论年龄、体型、残疾、种族、性别特征、性别认同和表达、经验水平、教育程度、社会经济地位、国籍、个人外表、种族、宗教或性别取向。
...
- 其他在专业环境中合理地被认为不适当的行为

## 执行责任

项目维护者有责任阐明并执行我们可接受行为的标准，并在回应中对任何不可接受的行为采取适当和公平的纠正措施。

## 范围

本行为准则适用于所有社区空间，也适用于个人在公共空间中代表社区时。

 ...
 *
 * 本文件定义插件市场生态所需的全部类型：
 * - PluginManifest：插件元数据清单（已迁移至 sdk/manifest-schema，此处 re-export）
...
// ==================== SDK 核心类型（从 sdk/manifest-schema re-export） ====================

export type { PluginPermission, PluginPricing, PluginCategory, PluginManifest } from './sdk/manifest-schema'
